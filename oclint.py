...
def lint_jsonfiles(jsonfiles):
    ...
    return result_files
# ref: https://oclint-docs.readthedocs.io/en/v0.7/customizing/reports.html
def lint(out_file):
        ...
        -max-priority-3=150000 \
        -max-priority-2=150000 \
        -max-priority-1=150000 \
        --report-type pmd \
        -o %s''' % (CYCLOMATIC_COMPLEXITY, LONG_CLASS, LONG_LINE, LONG_METHOD, NPATH_COMPLEXITY, NCSS_METHOD, NESTED_BLOCK_DEPTH, out_file)
        os.system(lint_command)
# FIX ERROR: oclint: error: one compiler command contains multiple jobs:
# configurate prj COMPILER_INDEX_STORE_ENABLE=NO
#
#
        # -max-priority-3=150000 \
        # -max-priority-2=150000 \
